...
public class ObjectSwitch extends InterfaceObject implements MouseListener {
   ...
   * @throws IOException
   */
  public ObjectSwitch(GameContainer gc, String label, List<Switchable> values)
   ...
   * @throws IOException
   */
  public ObjectSwitch(GameContainer gc, String label, List<Switchable> values, String info)
      throws SlickException, FontFormatException, IOException {
