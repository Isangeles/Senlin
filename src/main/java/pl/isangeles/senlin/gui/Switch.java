...
public final class Switch extends InterfaceObject implements MouseListener {
   ...
   */
  public Switch(GameContainer gc, String label, int value, Attribute points)
   ...
   * @throws FontFormatException
   */
  public Switch(GameContainer gc, String label, int value, Attribute points, String textForInfo)
      throws SlickException, IOException, FontFormatException {
