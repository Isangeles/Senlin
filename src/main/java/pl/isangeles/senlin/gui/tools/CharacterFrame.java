...
class CharacterFrame extends TargetFrame {
   ...
   */
  public CharacterFrame(GameContainer gc, Character character)
      throws SlickException, IOException, FontFormatException {
    super(gc, character);
    this.character = (Character) super.target;
    magicka =
        new Bar(GConnector.getInput("ui/bar/manaBar.png"), "uiManaBar", false, gc, "Magicka:");
    experience =
        new Bar(GConnector.getInput("ui/bar/expBar.png"), "uiExpBar", false, gc, "Experience:");
  }
  ...
  public void draw(float x, float y) {
    ...
    textTtf.drawString(
        super.x + getDis(150),
        super.y + getDis(110),
        TConnector.getText("ui", "levelName") + ":" + target.getLevel());
