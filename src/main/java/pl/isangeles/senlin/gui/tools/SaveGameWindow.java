...
class SaveGameWindow extends InterfaceObject implements UiElement, MouseListener {
  ...
  public SaveGameWindow(GameContainer gc) throws SlickException, IOException, FontFormatException {
    ...
    saveB =
        new Button(
            GConnector.getInput("button/buttonS.png"), "uiSaveGWinSave", false, "save game", gc);
    exitB =
        new Button(GConnector.getInput("button/buttonS.png"), "uiSaveGWinExit", false, "exit", gc);
    upB = new Button(GConnector.getInput("button/buttonUp.png"), "uiSaveGWinUp", false, "", gc);
    downB =
        new Button(GConnector.getInput("button/buttonDown.png"), "uiSaveGWinDown", false, "", gc);
    fileName =
        new TextInput(
