...
class SkillsMenu extends InterfaceObject implements UiElement, MouseListener {
  ...
  public SkillsMenu(GameContainer gc, Character player)
    ...
    pageSkills =
        new Button(
            GConnector.getInput("button/bookmark.png"),
            "uiBookmark",
            false,
            TConnector.getText("ui", "sMenuSkills"),
            gc);
    pageMagic =
        new Button(
            GConnector.getInput("button/bookmark.png"),
            "uiBookmark",
            false,
            TConnector.getText("ui", "sMenuMagic"),
            gc);
    pageAbilities =
        new Button(
            GConnector.getInput("button/bookmark.png"),
            "uiBookmark",
            false,
            TConnector.getText("ui", "sMenuAbi"),
            gc);
  ...
  public SkillSlot getDragged() {
    if (slots.getDragged() != null) return (SkillSlot) slots.getDragged();
