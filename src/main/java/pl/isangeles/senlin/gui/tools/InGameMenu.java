...
class InGameMenu extends InterfaceObject implements UiElement, MouseListener {
  ...
  public InGameMenu(GameContainer gc) throws SlickException, IOException, FontFormatException {
    ...
    resume =
        new Button(
            GConnector.getInput("ui/button/buttonMenuSmall.png"),
            "buttIGM",
            false,
            TConnector.getText("menu", "resName"),
            gc);
    save =
        new Button(
            GConnector.getInput("ui/button/buttonMenuSmall.png"),
            "buttIGM",
            false,
            TConnector.getText("menu", "sgName"),
            gc);
    load =
        new Button(
            GConnector.getInput("ui/button/buttonMenuSmall.png"),
  ...
  public void draw(float x, float y) {
    ...
    if (menuWarning.isOpenReq()) menuWarning.draw();
  ...
  public boolean isExitReq() {
    if (menuWarning.isAccept()) return exitReq;
    else return false;
  }
  /**
  ...
  public void mouseReleased(int button, int x, int y) {
    if (button == Input.MOUSE_LEFT_BUTTON) {
      ...
      if (save.isMouseOver()) saveReq = true;
      if (load.isMouseOver()) loadReq = true;
      if (settings.isMouseOver()) settingsReq = true;
    }
  }
