...
public class ScrollableList extends InterfaceObject implements MouseListener {
   ...
   * @throws IOException
   */
  public ScrollableList(int slotsAmount, GameContainer gc)
  ...
  public void draw(float x, float y, boolean scaledPos) {
    if (selectedS != null) selectTex.draw(selectedS.x, selectedS.y, selectedS.getScale());
  ...
  public ScrollableContent getSelected() {
    if (selectedS != null) return selectedS.getContent();
    else return null;
  }
  /**
