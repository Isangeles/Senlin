...
public abstract class Slot extends InterfaceObject implements MouseListener {
  ...
  private Slot(InputStream is, String ref, boolean flipped, GameContainer gc)
   ...
   *
   * @param dragged True to set whole content in slot as dragged, false to disable dragging in whole
   *     slot content
   */
