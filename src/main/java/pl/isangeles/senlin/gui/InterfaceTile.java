...
public abstract class InterfaceTile extends InterfaceObject implements MouseListener {
  ...
  public InterfaceTile(
      InputStream fileInput, String ref, boolean flipped, GameContainer gc, String info)
    ...
    super(
        ...
        gc,
        info,
        (int) Coords.getSize(45),
        (int) Coords.getSize(40));
  ...
  public void draw(float x, float y, boolean scaledPos) {
    ...
    if (!dragged) super.draw(x, y, 45f, 40f, scaledPos);
    else super.draw(gameInput.getMouseX(), gameInput.getMouseY(), 45f, 40f, scaledPos);
  }

  @Override
  public void draw(float x, float y, Color filter, boolean scaledPos) {
    if (!dragged) super.draw(x, y, 45f, 40f, filter, scaledPos);
    else super.draw(gameInput.getMouseX(), gameInput.getMouseY(), 45f, 40f, filter, scaledPos);
  }
