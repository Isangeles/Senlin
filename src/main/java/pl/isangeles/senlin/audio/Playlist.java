...
class Playlist extends HashMap<String, Music> {
  ...
  public void addAll(String category) throws IOException, SlickException {
    ...
    while (scann.hasNext()) {
      ...
      if (trackName.endsWith(".ogg") || trackName.endsWith(".aif")) add(category, trackName);
    }
    scann.close();
  }
  /**
   ...
   *
   * @return Currently played track from this playlist or null if all track in this playlist are
   *     stopped
   */
