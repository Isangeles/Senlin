...
public class AudioPlayer {
   ...
   * @param playlistName Playlist name
   * @param category Category name
   * @return True if tracks from specified category was successfully added to playlist, false
   *     otherwise
   */
  ...
  public void play(float pitch, float volume, String trackName) {
    ...
    if (track != null) {
      ...
      activePlaylist = mainList;
    } else Log.addSystem("audioPlayer_fail_msg///no such track: " + trackName);
  }
  /**
  ...
  public void playFrom(String playlist, float pitch, float volume, String trackName) {
    ...
    } else Log.addSystem("audioPlayer_fail_msg///no such playlist: " + playlist);
  }
  /**
