...
public class LoadMenu extends BasicGameState {
  ...
  public void init(GameContainer container, StateBasedGame game) throws SlickException {
    try {
      ...
      backB =
          new Button(
              GConnector.getInput("button/buttonS.png"), "loadMenuBack", false, "back", container);
      loadB =
          new Button(
              GConnector.getInput("button/buttonS.png"), "loadMenuLoad", false, "load", container);
      upB =
          new Button(
              GConnector.getInput("button/buttonUp.png"), "loadMenuUp", false, "", container);
      downB =
          new Button(
              GConnector.getInput("button/buttonDown.png"), "loadMenuDown", false, "", container);
  ...
  public void mouseReleased(int button, int x, int y) {
    if (button == Input.MOUSE_LEFT_BUTTON) {
      if (backB.isMouseOver()) backReq = true;
      if (loadB.isMouseOver()) loadReq = true;
    }
  }
  ...
  private class SaveSlot extends TextButton {
    ...
    public void draw(float x, float y, boolean scaledPos) {
      if (select) selectTex.draw(x, y, getScale());
