...
public class ChapterLoadingScreen extends BasicGameState {
  ...
  /**
   * Setup chapter loading screen loads next chapter of current module
   *
  ...
  public void init(GameContainer container, StateBasedGame game) throws SlickException {
    try {
      loadingInfo =
          new InfoField(100f, 70f, chapterName + System.lineSeparator() + "Loading...", container);
  ...
  public void update(GameContainer container, StateBasedGame game, int delta)
      throws SlickException {
    try {
      if (!loadChapter(container, game)) container.exit();
