...
/**
 * Class for damage bonus Note that this bonus is only dynamically added to character hit, i.e. not
 * affect character in any other way
 *
 * @author Isangeles
 */
public class DamageBonus extends Modifier {
  ...
  public DamageBonus(int dmgValue, WeaponType weaponType) {
    super(
        ModifierType.DAMAGE,
        TConnector.getText("ui", "bonDmg") + ":" + dmgValue + "(" + weaponType.getName() + ")");
