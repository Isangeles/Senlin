 ...
 * @author Isangeles
 */
public class AttitudeModifier extends Modifier {
  private Attitude attitude;
  /**
   * Attitude modifier constructor
   *
   * @param attitude Attitude to apply on object
   */
  public AttitudeModifier(Attitude attitude) {
    super(ModifierType.ATTITUDE, "");
  ...
  public void applyOn(Targetable object) {
    if (Character.class.isInstance(object)) ((Character) object).setAttitude(attitude);
  }
  /* (non-Javadoc)
