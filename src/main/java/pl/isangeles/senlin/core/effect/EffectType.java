...
public enum EffectType {
  ...
  public Sound getActivationSoundEffect() throws SlickException, IOException {
    switch (this) {
      ...
      case NATURE:
        return new Sound(
            AConnector.getInput("effects/hit01.ogg"), "hit01.ogg"); // TODO nature sound
      case MAGIC:
   ...
   */
  public SimpleAnim getActivationGraphicEffect(GameContainer gc)
      throws SlickException, IOException {
    switch (this) {
      case FIRE:
        return new SimpleAnim(
            GConnector.getInput("effect/fireSpellActive.png"),
            "fireSpellA.png",
            false,
            70,
            70,
  ...
  public SimpleAnim getCastGraphicEffect(GameContainer gc) throws SlickException, IOException {
    switch (this) {
      case FIRE:
        return new SimpleAnim(
            GConnector.getInput("effect/fireSpellCast.png"),
            "fireSpellC.png",
            false,
            70,
            70,
