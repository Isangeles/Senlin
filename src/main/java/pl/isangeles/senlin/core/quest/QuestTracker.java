...
public class QuestTracker {
  ...
  /**
   * Checks if specified objective target matches to one of character quest objectives, also checks
   * if specified objective target is trigger of one of quests to start
   *
  ...
  public void addQuestToStart(Quest quest, String trigger) {
    if (trigger.equals("now")) character.startQuest(quest);
    else questsToStart.put(quest.getId(), trigger);
  }
}
