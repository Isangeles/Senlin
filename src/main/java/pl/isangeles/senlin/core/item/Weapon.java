...
public class Weapon extends Equippable {
  ...
  public Weapon(
    ...
    itemMSprite =
        new AnimObject(
            GConnector.getInput("sprite/item/" + spriteName), "sprite" + id, false, 80, 90);
  }
  /**
  ...
  public Weapon(
      ...
      throws SlickException, IOException, FontFormatException {
    super(
        id, serial, value, picName, gc, bonuses, equipEffects, equipReq, type.ordinal(), material);
    this.minDamage = minDmg;
    this.maxDamage = maxDmg;
    this.hitEffects = hitEffects;
    this.itemTile = this.buildIcon(gc);
  ...
  public Weapon(
    ...
    this(
        ...
        equipReq,
        picName,
        type.getDefaultMaleSpritesheet(),
        gc);
  }
  /**
  ...
  public Effect getHitEffect(String effectId) {
    for (String id : hitEffects) {
      if (id.equals(effectId)) return EffectsBase.getEffect(this, id);
    }
    return null;
  }
  /**
  ...
  protected void setMSprite(String ssName) throws IOException, SlickException {
    itemMSprite =
        new AnimObject(GConnector.getInput("sprite/item/" + ssName), "sprite" + id, false, 80, 90);
  }
  /* (non-Javadoc)
