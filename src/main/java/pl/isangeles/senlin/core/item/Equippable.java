...
public abstract class Equippable extends Item implements EffectSource {
   ...
   * @param reqLevel Required level to equip(only for backward compatibility, now requirement in
   *     {@link Eqippable#equipReq})
  ...
  public void reset() {
    if (itemMSprite != null) itemMSprite.reset();
    if (itemFSprite != null) itemFSprite.reset();
  }
  /**
