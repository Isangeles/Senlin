...
public class EffectAction extends Action implements EffectSource {
  ...
  public EffectAction(String effectOnActionId, String target) {
    if (target.equals("user")) type = ActionType.EFFECTUSER;
    if (target.equals("target")) type = ActionType.EFFECTTARGET;
  ...
  public Collection<Effect> getEffects() {
    ...
    // TODO interestingly, after starting action building effects cause infinite loop, this is some
    // fix for that
    antiLoopCounter++;
