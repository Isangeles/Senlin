...
/**
 * This class provides static methods giving access to graphic archive and other external graphics
 * files
 *
 * @author Isangeles
 */
public final class GConnector {
  ...
  private GConnector() {}
  /**
   * Return InputStream pointed on specific file in graphic archive WARNING If gArch will be closed
   * in these method then returned InputStrem will be closed too
   *
  ...
  /**
   * This static method reads file with image names in portrait folder and adds these files to Image
   * List
   *
