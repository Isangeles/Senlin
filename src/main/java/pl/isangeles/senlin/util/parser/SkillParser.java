...
public final class SkillParser {
   ...
   */
  public static AttackPattern getAttackFromNode(Node skillNode)
    ...
    int cooldown =
        Integer.parseInt(skillE.getElementsByTagName("cooldown").item(0).getTextContent());
   ...
   * @throws NoSuchElementException
   */
  public static BuffPattern getBuffFromNode(Node skillNode)
      throws NumberFormatException, NoSuchElementException {
    Element skillE = (Element) skillNode;
    String id = skillE.getAttribute("id");
    ...
    return new BuffPattern(
        id, imgName, effect, type, useReqs, cooldown, cast, range, effects, trainReq);
  }
  /**
