...
public final class Settings {
  ...
  private Settings() {}
  /**
   * Tries to load settings from settings file, if file was not found default settings will be
   * loaded settings file construction: [setting];[newline mark]
   */
  static {
    try {
  ...
  public static boolean saveSettings() {
    ...
    try {
      ...
      if (newLangId != null || newLangId != "") pw.write("language:" + newLangId);
      else pw.write("language:" + langId);
      pw.write(";" + System.lineSeparator());

      if (newResolution != null) pw.write("resolution:" + newResolution);
      else pw.write("resolution:" + resolution);
      pw.write(";" + System.lineSeparator());
