...
public class WorldMan implements CliTool {
    ...
    try {
      ...
      switch (option) {
        ...
        case "--npc":
          ...
          if (npc != null) {
            if (!world.getCurrentChapter().removeTObject(npc)) result = "2";
          } else {
    ...
    try {
      ...
      switch (option) {
        ...
        case "--play":
          ...
          } else world.getMusiPlayer().playRandomFrom("exploring", 1.0f, Settings.getMusicVol());
          break;
        case "-s":
        case "--stop":
        ...
        case "--list":
          ...
          } else out = arg1 + ":" + world.getMusiPlayer().getTracksList();
          break;
        case "-n":
        case "--next":
  ...
  private String[] addCommands(String commandLine) {
    ...
    try {
      ...
      if (scann.hasNext()) arg3 = scann.next();
      ...
      switch (option) {
        ...
        case "--character":
          String charId = arg1;
          String[] pos = {
            world.getPlayer().getPosition()[0] + "", world.getPlayer().getPosition()[1] + ""
          };
          String area = world.getArea().getId();
          if (arg2 != null) pos = arg2.split("x");
          if (arg3 != null) area = arg3;

          TilePosition p = new TilePosition(pos[0] + ";" + pos[1]);
          Character spawnedChar =
              NpcBase.spawnIn(
                  charId, world.getCurrentChapter().getActiveScenario().getArea(area), p);
    ...
    try {
      ...
      switch (option) {
        ...
        case "--time":
          ...
          int minutes = 0;
          if (arg2 != null) minutes = Integer.parseInt(arg2);
        ...
        case "-c":
        case "--chapter":
          if (arg1.equals("next")) world.setNextChapterReq();
          break;
        default:
          result = "3";
          break;
