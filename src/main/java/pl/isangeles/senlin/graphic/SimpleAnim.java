...
public class SimpleAnim extends GameObject {
  ...
  public SimpleAnim(
    ...
    switch (nOfFrames) {
      case 3:
        frames =
            new Sprite[] {
              new Sprite(ss.getSubImage(0, 0)),
              new Sprite(ss.getSubImage(1, 0)),
              new Sprite(ss.getSubImage(2, 0))
            };
      ...
      case 5:
        frames =
            new Sprite[] {
              new Sprite(ss.getSprite(0, 0)),
              new Sprite(ss.getSprite(1, 0)),
              new Sprite(ss.getSprite(2, 0)),
              new Sprite(ss.getSprite(3, 0)),
              new Sprite(ss.getSprite(4, 0))
            };
    ...
    objectMOA =
        new MouseOverArea(
            gc, anim.getCurrentFrame(), (int) Coords.getX("BR", 0), (int) Coords.getY("BR", 0));
  ...
  public void draw(float x, float y, float scale, boolean scaledPos) {
    ...
    anim.draw(
        x,
        y,
        (anim.getCurrentFrame().getWidth() * getScale()) * scale,
        (anim.getCurrentFrame().getHeight() * getScale()) * scale);
    if (infoWin != null) {
      if (objectMOA.isMouseOver()) infoWin.draw(x, y);
    }
  }
