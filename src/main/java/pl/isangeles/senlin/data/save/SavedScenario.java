...
/**
 * Class for saved scenarios Saves scenario elements from SSG to load it later
 *
 * @author Isangeles
 */
public class SavedScenario {
  ...
  public SavedScenario(Element scenarioE) throws InvalidDocumentElementException {
    ...
    if (mainareaE != null) mainareaId = mainareaE.getAttribute("id");
    else
      throw new InvalidDocumentElementException(
          "Fail to find mainarea node in specified scenario element");
  }
  /**
   ...
   */
  public Scenario load(GameContainer gc)
