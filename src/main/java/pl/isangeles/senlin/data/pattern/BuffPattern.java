...
public class BuffPattern implements SkillPattern {
   ...
   */
  public Buff make(Character character, GameContainer gc)
      throws SlickException, IOException, FontFormatException {
    return new Buff(
        character, id, imgName, effect, type, useReqs, castTime, range, cooldown, effects, gc);
  }
}
